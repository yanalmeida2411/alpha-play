...
export function GameFinishedModal({
  ...
  return (
    <div className="fixed inset-0 z-10 flex items-center justify-center bg-black/50 backdrop-blur-md p-4 transition-all duration-300">
      <div className="rounded-lg px-12.25 py-8 flex flex-col items-center text-center bg-white">
        <div className="relative w-full h-44 mb-4">
          <Image
            src="/assets/foxEndGame.png"
            alt="Parabéns"
            fill
        ...
        <div className="flex gap-6 justify-center">
          ...
          >
            ...
            <span className="leading-none">Voltar Home</span>
          </button>
        </div>
      </div>
    </div>
